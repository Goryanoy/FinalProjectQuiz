...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.txt_leve3);
        ...
        //set dialog window font
        LinearLayout dialogfont = (LinearLayout)dialog.findViewById(R.id.dialogfon);
        dialogfont.setBackgroundResource(R.drawable.previewbackground3);

        //set description
        TextView textdescription = (TextView)dialog.findViewById(R.id.textdescription);
        textdescription.setText(R.string.leveltree);
        ...
        textdescriptionEnd.setText(R.string.leveltreeEnd);
        ...
        img_left.setImageResource(array.images3[numLeft]);//get pic from an array
        text_left.setText(array.text3[numLeft]);//get the text from an array
        ...
        img_right.setImageResource(array.images3[numRight]);//get pic from an array
        text_right.setText(array.text3[numRight]);//get the text from an array

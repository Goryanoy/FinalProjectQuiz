...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.txt_leve1);
        ...
        img_left.setImageResource(array.images1[numLeft]);//get pic from an array
        text_left.setText(array.texts1[numLeft]);//get the text from an array
        ...
        img_right.setImageResource(array.images1[numRight]);//get pic from an array
        text_right.setText(array.texts1[numRight]);//get the text from an array
